...
import { tablesDB, ID, appwriteConfig } from "~/appwrite/client";
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  try {
    ...
    "estimatedPrice": "Lowest average price for the trip in USD, e.g.price (type should be number without USD symbol),",
