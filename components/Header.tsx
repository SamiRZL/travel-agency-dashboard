...
const Header = ({ title, description, ctaText, cta }: { title: string, description: string, ctaText?: string, cta?: string }) => {
    ...
    return (
        <header className="header">
            ...
            {ctaText && cta && (
                <Link to={cta}>
                    <ButtonComponent type='button' className="button-class !h11 !w-full md:w-[350px]">
